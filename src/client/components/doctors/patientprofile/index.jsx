														...
														<table className="table table-hover table-center mb-0">
															...
															<tbody>
																<tr>
																	...
																	<td className="text-end">
																		<div className="table-action">
																			<Link to="#" className="btn btn-sm bg-success-light me-1">
																...
																<tr>
																	...
																	<td className="text-end">
																		<div className="table-action">
																			<Link to="/editprescription" className="btn btn-sm bg-success-light me-1">
																				<i className="far fa-edit"></i> Edit
																			</Link>
														...
														<table className="table table-hover table-center mb-0">
															...
															<tbody>
																...
																<tr>
																	...
																	<td className="text-end">
																		<div className="table-action">
																			<Link to="#" className="btn btn-sm bg-primary-light me-1">
																				<i className="fas fa-print"></i> Print
																			</Link>
																			<Link to="#" className="btn btn-sm bg-info-light me-1">
																				<i className="far fa-eye"></i> View
																			</Link>
																			<Link to="/editprescription" className="btn btn-sm bg-success-light me-1">
																...
																<tr>
																	...
																	<td className="text-end">
																		<div className="table-action">
																			...
																			<Link to="/editbilling" className="btn btn-sm bg-success-light me-1">
																				<i className="fas fa-edit"></i> Edit
																			</Link>
																			<Link to="#" className="btn btn-sm bg-danger-light">
																				<i className="far fa-trash-alt"></i> Delete
