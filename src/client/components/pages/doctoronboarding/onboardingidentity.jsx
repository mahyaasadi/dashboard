              ...
              <div className="col-lg-8 col-md-12">
                <div className="onboarding-content-box">
                  <div className="onboarding-title">
                    ...
                    <h6>
                      We need to determine if an identity document is authentic and
                      belongs to you. You just need to go through some steps which
                      will help us to build a secure system together
                    </h6>
                  </div>
                    ...
                    <div className="row">
                      <div className="col-lg-12">
                        <div className="form-group">
                          ...
                          <Select styles={customStyles} options={options} placeholder="Select Document Type" />
                  ...
                  <div className="onboarding-btn Personalize-btn">
                    <Link to="#" data-bs-toggle="modal" data-bs-target="#id-verified">
                      Continue
                    </Link>
                  </div>
                  {/* Modal */}
                      ...
                      <div className="modal-content id-pop-content">
                        ...
                        <div className="modal-footer id-pop-footer text-center">
                          <div className="onboarding-btn pop-btn ">
                            <Link to="/pages/onboarding-personalize">Continue</Link>
                          </div>
                        </div>
                      </div>
                    </div>
