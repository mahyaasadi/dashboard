                        ...
                        <div className="doctor-widget">
                            ...
                            <div className="clini-infos">
                                <ul>
                                    ...
                                    <li>
                                        <i className="far fa-money-bill-alt"></i> $50 - $300 <OverlayTrigger overlay={
                                        <Tooltip id="tooltip-disabled">Lorem Ipsum</Tooltip>
                                        }>
                                        <span className="d-inline-block">
                                        <i className="fas fa-info-circle"></i>
                        ...
                        <div className="doctor-widget">
                            ...
                            <div className="clini-infos">
                                <ul>
                                    ...
                                    <li><i className="fas fa-map-marker-alt"></i> Newyork, USA</li>
                                    <li>
                                        <i className="far fa-money-bill-alt"></i> $100 - $400 <OverlayTrigger overlay={
                                        <Tooltip id="tooltip-disabled">Lorem Ipsum</Tooltip>
                                        }>
                                        <span className="d-inline-block">
                                        <i className="fas fa-info-circle"></i>
                        ...
                        <div className="doctor-widget">
                            ...
                            <div className="clini-infos">
                                <ul>
                                    ...
                                    <li><i className="fas fa-map-marker-alt"></i> Newyork, USA</li>
                                    <li>
                                        <i className="far fa-money-bill-alt"></i> $150 - $250 <OverlayTrigger overlay={
                                        <Tooltip id="tooltip-disabled">Lorem Ipsum</Tooltip>
                                        }>
                                        <span className="d-inline-block">
                                        <i className="fas fa-info-circle"></i>
                        ...
                        <div className="doctor-widget">
                            ...
                            <div className="clini-infos">
                                <ul>
                                    ...
                                    <li>
                                        <i className="far fa-money-bill-alt"></i> $100 - $500 <OverlayTrigger overlay={
                                        <Tooltip id="tooltip-disabled">Lorem Ipsum</Tooltip>
                                        }>
                                        <span className="d-inline-block">
                                        <i className="fas fa-info-circle"></i>
