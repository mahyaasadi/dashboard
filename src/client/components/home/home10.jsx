  ...
  <div className="main-wrapper">
      ...
      <div className="container">
        ...
        <div className="row">
          <div className="col-md-12 aos" data-aos="fade-up">
            <div className="doctor-book-slider slider" dir="rtl">
             <Slider {...doctors} ref={slider}>
        ...
        <div className="row">
          <div className="col-md-12 text-end">
            <div className="slick-view-btn me-2">
							<Link to="/patient/doctor-profile" className="btn">View More <i className="fas fa-arrow-left ms-2"></i></Link>
						</div>
            <div>
            </div>
          </div>
    ...
    <section className="features-section">
      <div className="container">
        ...
        <div className="row">
          <div className="col-md-12 aos" data-aos="fade-up">
            <div className="features-section-slider slider" dir="rtl">
          ...
          <div className="col-md-12 text-end">
            <div className="slick-view-btn me-2">
							<a href="#" className="btn">
								View More <i className="fas fa-arrow-left ms-2"></i>
							</a>
						</div>
            {/* <div>
              <button className="slick-prev slick-arrow prev" onClick={() => slider1.current.slickNext()}></button>
              <button className="slick-next slick-arrow"onClick={() => slider1.current.slickPrev()}></button>
            </div> */}
          </div>
        </div>
      </div>
