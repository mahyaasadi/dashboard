  ...
  const url = pathnames.split("/").slice(0, -1).join("/");
      ...
      <section className="section section-search-1">
        ...
        <header className="header">
          <nav className={`navbar navbar-expand-lg header-nav nav-transparent ${pathnames.includes("home1") ? "nav-transparent" : "" }`}>
              ...
              {pathnames.includes("voice-call") || pathnames.includes("video-call") ? (
                ...
                <>
                  <li className="nav-item">
                    <Link to="/login" className="nav-link header-login border-0">
                      login / Signup{" "}
                    </Link>
                  </li>{" "}
                </>
