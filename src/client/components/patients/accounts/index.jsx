                              ...
                              <div className="card-header">
                                <div className="row">
                                  ...
                                  <div className="col-sm-6">
                                    ...
                                    <a title="Edit Profile" className="btn btn-primary btn-sm" href="#account_modal" data-bs-toggle="modal" onClick={() => setShow((s) => !s)}><i className="fas fa-pencil"></i> Edit Details</a>
                                    </div>
                                  </div>
                                </div>
                              </div>
                            ...
                            <div className="card flex-fill">
                              <div className="card-body">
                                <div className="row">
                                  ...
                                  <a href="#payment_request_modal" className="btn btn-primary request_btn" data-bs-toggle="modal">Refund Request</a>
                                  </div>
                                </div>
                              </div>
                            </div>
