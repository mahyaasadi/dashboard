							...
							<form action="/admin/pharmacy-list">
								<div className="add-wrap">
									<div className="form-group form-focus">
										...
										<label className="focus-label">Pharmacy Name<span className="text-danger">*</span></label>
									</div>
									 <SelectField 
									...
									<div className="form-group form-focus">
										<input type="text" className="form-control floating"/>
										<label className="focus-label">Pharmacy Address <span className="text-danger">*</span></label>
									</div>
									...
									<div className="form-group form-focus">
										<input type="text" className="form-control floating"/>
										<label className="focus-label">Administrator Name <span className="text-danger">*</span></label>
									</div>
									<div className="form-group form-focus">
										<input type="text" className="form-control floating"/>
										<label className="focus-label">Phone Number <span className="text-danger">*</span></label>
									</div>
						...
						<div className="modal-body">
							<form action="/admin/pharmacy-list">
								<div className="add-wrap">
									...
									/>
									<div className="form-group form-focus">
										<input type="text" className="form-control floating" defaultValue="96 Red Hawk Road Cyrus, MN 56323"/>
										<label className="focus-label">Pharmacy Address <span className="text-danger">*</span></label>
									</div>
									<div className="change-photo-btn">
										<div>
									...
									<p className="file-name text-success">Product image.jpg <a href="#" className="text-danger"><i><FeatherIcon icon="x"/></i></a></p>
									<div className="form-group form-focus">
										<input type="text" className="form-control floating" defaultValue="Patinson"/>
										<label className="focus-label">Administrator Name <span className="text-danger">*</span></label>
									</div>
									<div className="form-group form-focus">
										<input type="text" className="form-control floating" defaultValue="8789904950"/>
										<label className="focus-label">Phone Name <span className="text-danger">*</span></label>
									</div>
									<div className="submit-section">
										<button type="submit" className="btn btn-primary btn-save">Save Changes</button>
									</div>								
