                ...
                <div id="sidebar-menu" className="sidebar-menu">
                    <ul>
                        ...
                        <li className="submenu">
                            <Link to="#"><i className="fe fe-document"></i> <span> Reports</span> <span className="menu-arrow"></span></Link>
                            <ul>
                        ...
                        <li className="submenu">
                            <Link to="#"><i className="fe fe-document"></i> <span> Authentication </span> <span className="menu-arrow"></span></Link>
                            <ul>
                        ...
                        <li className="submenu">
                            <Link to="#"><i className="fe fe-warning"></i> <span> Error Pages </span> <span className="menu-arrow"></span></Link>
                            <ul>
                        ...
                        <li className="submenu">
                            <Link to="#"><i className="fe fe-layout"></i> <span> Forms </span> <span className="menu-arrow"></span></Link>
                            <ul >
                        ...
                        <li className="submenu">
                            <Link to="#"><i className="fe fe-table"></i> <span> Tables </span> <span className="menu-arrow"></span></Link>
                            <ul >
                        ...
                        <li className="submenu">
                            <Link to="#0"><i className="fe fe-code"></i> <span>Multi Level</span> <span className="menu-arrow"></span></Link>
                            <ul >
                                <li className="submenu">
                                    <Link to="#0"> <span>Level 1</span> <span className="menu-arrow"></span></Link>
                                    <ul >
                                        <li><Link to="#0"><span>Level 2</span></Link></li>
                                        <li className="submenu">
                                            <Link to="#0"> <span> Level 2</span> <span className="menu-arrow"></span></Link>
                                            <ul >
                                                <li><Link to="#0">Level 3</Link></li>
                                                <li><Link to="#0">Level 3</Link></li>
                                            </ul>
                                        </li>
                                        <li><Link to="#0"> <span>Level 2</span></Link></li>
                                ...
                                <li>
                                    <Link to="#0"> <span>Level 1</span></Link>
                                </li>
                            </ul>
                        </li>
                    </ul>
